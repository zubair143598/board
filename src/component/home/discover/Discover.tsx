...
const Discover = () => {
  ...
  return (
    <DiscoverContainer>
      <DiscoverInnerCon>
        <LeftContainer>
          <img src={isMobile ? "/DiscoverImage2.png" : "/DiscoverImage.png"}  alt="" style={{ height:'100%', width:'100%'}} />
        </LeftContainer>
        <RightContainer>
          <DisHeading>
            Discover the <br /><DisSpan>Virtual</DisSpan> Reality Gaming
          </DisHeading>
          <Para>
          ...
          <NonActiveButton sx={{ margin:'35px 20px 0'}}>Play Now</NonActiveButton>
        </RightContainer>
      </DiscoverInnerCon>
      <MarqueeContainer>
      <MarqueeSwiper/>
